...
def main():
    ...
    # **Application to predicts the peer 2 peer interest rate with ML model explaination**!
    # """)
    st.write('---')
    ...
    emp_length_sb = st.sidebar.selectbox("Employment length in year", optionemplength, key="selectb1")
